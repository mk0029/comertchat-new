...
import { CometChatButton, CometChatCallLogs, CometChatContextMenu, CometChatConversations, CometChatOption, CometChatUIKit, CometChatUIKitLoginListener, CometChatUsers, getLocalizedString, Placement } from "@cometchat/chat-uikit-react";
...
import { FilteredCometChatGroups } from "../FilteredCometChatGroups";
            ...
            {loggedInUser && <>
                {showJoinGroup && group && (
                    <CometChatJoinGroup
                        group={group}
                        onHide={onHide}
                        onProtectedGroupJoin={(joinedGroup: Group) => onProtectedGroupJoin(joinedGroup)}
                    />
                )}
                {activeTab == "chats" ? (
                ...
                {showCreateGroup && (
                    <>
                        <CometChatCreateGroup
                            ...
                            onGroupCreated={(createdGroup: Group) => onGroupCreated(createdGroup)}
                        />
                    </>
                )}
            </>}
